...
* ********************* */
async function checkCorrectPassword(account_email){
  try {
...
module.exports = { registerAccount, checkExistingEmail, checkCorrectPassword, getAccountByEmail, getAccountById, updateAccount, updatePassword }